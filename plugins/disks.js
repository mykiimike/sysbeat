	...
	function rotate() {
		...
		cmd.on('close', (code) => {
			...
			for(var a=1; a<lines.length; a++) {
				...
				self.app.dataPoint('disks', {disk: line[0], mount: line[5], key: 'total' }, {value: line[1], percent: 100}, now);
				self.app.dataPoint('disks', {disk: line[0], mount: line[5], key: 'used' }, {value: line[2], percent: percent}, now);
			}
